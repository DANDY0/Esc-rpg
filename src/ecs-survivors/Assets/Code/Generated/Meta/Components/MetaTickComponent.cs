...
public partial class MetaEntity {
    ...
    public Code.Meta.Features.Simulation.SimulationComponents.Tick tick { get { return (Code.Meta.Features.Simulation.SimulationComponents.Tick)GetComponent(MetaComponentsLookup.Tick); } }
    ...
    public MetaEntity AddTick(float newValue) {
        ...
        var component = (Code.Meta.Features.Simulation.SimulationComponents.Tick)CreateComponent(index, typeof(Code.Meta.Features.Simulation.SimulationComponents.Tick));
